...
function App() {
  ...
  return (
    <>
      <StyledNavBar>
        <a href="/keyboard">Keyboard Warrior</a>
        <a href="/too-much">Nice Design</a>
        <a href="/colours">colours</a>
        <a href="/language">G`day Bosh</a>
        <a href="/blind">Blind? I got you</a>
        <a href="/image">Image City, kinda</a>
      </StyledNavBar>
